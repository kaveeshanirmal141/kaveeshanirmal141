...
## Experience
- Built and attacked a full Active Directory homelab (AD DS, ADCS, DNS, multi-host environment)
- Performed ADCS exploitation (ESC paths) and certificate-based attacks
- Hands-on web exploitation: SQLi, SSRF, IDOR, SSTI, XXE, RCE chains
- Executed cloud attack paths (SSRF → IMDS → temporary credentials → privilege escalation)
- Worked with real-world CVEs and lab-based exploitation scenarios
- Created and deployed custom CTF challenges (OSINT, Forensics, Crypto)
- Built vulnerable web apps using Docker for testing and exploitation
- Consistent hands-on training (TryHackMe top percentile)
